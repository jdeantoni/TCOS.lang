...
// rule evaluateConjunction4
   ...
   //conclusion: terminates:event
    ...
    createConjunctionLocalCCFG(node: Conjunction): CCFG {
        ...
        let forkevaluateConjunctionStage0: Node = new Fork(node)
        localCCFG.addNode(forkevaluateConjunctionStage0)
        {let e = localCCFG.addEdge(startsConjunctionNode,forkevaluateConjunctionStage0)
        e.guards = [...e.guards, ...[]]}
            

        {let e = localCCFG.addEdge(forkevaluateConjunctionStage0,lhsHole)
        e.guards = [...e.guards, ...[]]}
    

        {let e = localCCFG.addEdge(forkevaluateConjunctionStage0,rhsHole)
        e.guards = [...e.guards, ...[]]}
    
        // premise handling for rule evaluateConjunction2: 1 participant groups
        ...
        // premise handling for rule evaluateConjunction3: 1 participant groups
        ...
        // premise handling for rule evaluateConjunction4: 2 participant groups
...
// rule finishPlus
   ...
   //conclusion: terminates:event
    ...
    createPlusLocalCCFG(node: Plus): CCFG {
        ...
        let forkstartPlusStage0: Node = new Fork(node)
        localCCFG.addNode(forkstartPlusStage0)
        {let e = localCCFG.addEdge(startsPlusNode,forkstartPlusStage0)
        e.guards = [...e.guards, ...[]]}
            

        {let e = localCCFG.addEdge(forkstartPlusStage0,rightHole)
        e.guards = [...e.guards, ...[]]}
    

        {let e = localCCFG.addEdge(forkstartPlusStage0,leftHole)
        e.guards = [...e.guards, ...[]]}
    
        // premise handling for rule finishPlus: 2 participant groups
        // Creating AndJoin for conjunction/disjunction
        ...
        finishPlusAndJoinNode.functionsDefs =[...finishPlusAndJoinNode.functionsDefs, ...[new CreateVarInstruction(this.getASTNodeUID(node)+`4543`,`int`),new AssignVarInstruction(this.getASTNodeUID(node)+`4543`,`n1`,`int`),new CreateVarInstruction(this.getASTNodeUID(node)+`4548`,`int`),new AssignVarInstruction(this.getASTNodeUID(node)+`4548`,`n2`,`int`),new CreateVarInstruction(`${this.getASTNodeUID(node)}4542`,`int`),new OperationInstruction(`${this.getASTNodeUID(node)}4542`,`${this.getASTNodeUID(node)}4543`,`+`,`${this.getASTNodeUID(node)}4548`,`int`),new CreateVarInstruction(`${this.getASTNodeUID(node)}terminates`,`int`),new AssignVarInstruction(`${this.getASTNodeUID(node)}terminates`,`${this.getASTNodeUID(node)}4542`,`int`),new ReturnInstruction(`${this.getASTNodeUID(node)}terminates`),]] // GG
...
// rule evalBooleanConst
   ...
   //conclusion: terminates:event
    ...
    createBooleanConstLocalCCFG(node: BooleanConst): CCFG {
        ...
        startsBooleanConstNode.functionsDefs =[...startsBooleanConstNode.functionsDefs, ...[new CreateVarInstruction(`${this.getASTNodeUID(node)}4771`,`bool`),new SetVarFromGlobalInstruction(`${this.getASTNodeUID(node)}4771`,`${this.getASTNodeUID(node)}constantValue`,`bool`),new CreateVarInstruction(`${this.getASTNodeUID(node)}terminates`,`bool`),new AssignVarInstruction(`${this.getASTNodeUID(node)}terminates`,`${this.getASTNodeUID(node)}4771`,`bool`),new ReturnInstruction(`${this.getASTNodeUID(node)}terminates`),]] // GG
...
// rule periodicBodyStart
   ...
   //conclusion: bloc:Bloc,starts:event
    ...
    createPeriodicBlocLocalCCFG(node: PeriodicBloc): CCFG {
        ...
        let forkperiodicBodyStartStage0: Node = new Fork(node)
        localCCFG.addNode(forkperiodicBodyStartStage0)
        {let e = localCCFG.addEdge(blocTriggerHole,forkperiodicBodyStartStage0)
        e.guards = [...e.guards, ...[]]}
            

        {let e = localCCFG.addEdge(forkperiodicBodyStartStage0,blocHole)
        e.guards = [...e.guards, ...[]]}
    

        {let e = localCCFG.addEdge(forkperiodicBodyStartStage0,blocTriggerHole)
        e.guards = [...e.guards, ...[]]}
