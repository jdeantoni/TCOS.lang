...
def function21fugaceStmt1(): 
	...
	sigma_mutex.release()
def function24fugaceStmt1(): 
	print("	function24fugaceStmt1 started") 
	sigma_mutex.acquire()
...
def function31fugaceStmt2(): 
	...
	sigma_mutex.release()
def function34fugaceStmt2(): 
	print("	function34fugaceStmt2 started") 
	sigma_mutex.acquire()
	sigma["Stmt21_33_1_38fakeState"] = int()
	sigma_mutex.release()
	sigma_mutex.acquire()
	sigma["Stmt21_33_1_38fakeState"] = 0
	sigma_mutex.release()
def main(): 
	function4perioStart() 
	sync9 = Queue() 
