...
void function6perioStart()
{
    std::cout << "	function6perioStart started" << std::endl;
    {
        ...
        sigma["Perio2_0_4_1blocTrigger"] = new int();
    }
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        *((int *)sigma["Perio2_0_4_1blocTrigger"]) = 1000;
    }
}
...
void function31fugaceStmt1()
{
    ...
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        sigma["Stmt13_18_3_23fakeState"] = new int();
    }
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        *((int *)sigma["Stmt13_18_3_23fakeState"]) = 0;
    }
}
void function34fugaceStmt1()
{
    ...
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        sigma["Stmt13_25_3_30fakeState"] = new int();
    }
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        *((int *)sigma["Stmt13_25_3_30fakeState"]) = 0;
    }
}
void function45fugaceStmt2()
{
    ...
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        sigma["Stmt23_38_3_43fakeState"] = new int();
    }
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        *((int *)sigma["Stmt23_38_3_43fakeState"]) = 0;
    }
}
void function48fugaceStmt2()
{
    ...
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        sigma["Stmt23_46_3_51fakeState"] = new int();
    }
    {
        const std::lock_guard<std::mutex> lock(sigma_mutex);
        *((int *)sigma["Stmt23_46_3_51fakeState"]) = 0;
    }
}
int main()
{
