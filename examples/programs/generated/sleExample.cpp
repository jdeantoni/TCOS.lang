...
void function24fugaceStmt1(){
std::cout << "	function24fugaceStmt1 started" << std::endl;
...
void function34fugaceStmt2(){
std::cout << "	function34fugaceStmt2 started" << std::endl;
	{const std::lock_guard<std::mutex> lock(sigma_mutex);	sigma["Stmt21_33_1_38fakeState"] = new int();}
	{const std::lock_guard<std::mutex> lock(sigma_mutex);	*((int*)sigma["Stmt21_33_1_38fakeState"]) = 0;}
}
int main(){
		function4perioStart();
	bool flag9 = true;
