...
int Variable2_0_2_111381;
Variable2_0_2_111381 = 42;
{const std::lock_guard<std::mutex> lock(sigma_mutex);*((int*)sigma["Variable2_0_2_11currentValue"]) = Variable2_0_2_111381;
}}
int function18accessVarRef(){
int VarRef4_7_4_91587;
{const std::lock_guard<std::mutex> lock(sigma_mutex);VarRef4_7_4_91587 = *(int*)sigma["Variable0_0_0_10currentValue"];
}int VarRef4_7_4_9terminates;
VarRef4_7_4_9terminates = VarRef4_7_4_91587;
return VarRef4_7_4_9terminates;
}
void function26executeAssignment2(int resRight){
int Assignment6_4_6_112528;
Assignment6_4_6_112528 = resRight;
{const std::lock_guard<std::mutex> lock(sigma_mutex);*((int*)sigma["Variable0_0_0_10currentValue"]) = Assignment6_4_6_112528;
}}
void function32executeAssignment2(int resRight){
int Assignment7_4_7_112528;
Assignment7_4_7_112528 = resRight;
{const std::lock_guard<std::mutex> lock(sigma_mutex);*((int*)sigma["Variable1_0_1_10currentValue"]) = Assignment7_4_7_112528;
}}
int function27accessVarRef(){
int VarRef6_9_6_111587;
{const std::lock_guard<std::mutex> lock(sigma_mutex);VarRef6_9_6_111587 = *(int*)sigma["Variable1_0_1_10currentValue"];
}int VarRef6_9_6_11terminates;
VarRef6_9_6_11terminates = VarRef6_9_6_111587;
return VarRef6_9_6_11terminates;
}
int function33accessVarRef(){
int VarRef7_9_7_111587;
{const std::lock_guard<std::mutex> lock(sigma_mutex);VarRef7_9_7_111587 = *(int*)sigma["Variable2_0_2_11currentValue"];
}int VarRef7_9_7_11terminates;
VarRef7_9_7_11terminates = VarRef7_9_7_111587;
