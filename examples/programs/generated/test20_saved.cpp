		...
		using SigmaValue = std::any;

		std::unordered_map<std::string, SigmaValue> sigma;
		std::mutex sigma_mutex;  // protects sigma

		template <typename T>
		void sigmaStore(const std::string& key, T value){
			const std::lock_guard<std::mutex> lock(sigma_mutex);
			sigma[key] = value;
		}

		template <typename T>
		T sigmaLoad(const std::string& key){
			const std::lock_guard<std::mutex> lock(sigma_mutex);
			auto it = sigma.find(key);
			if (it == sigma.end()) {
				throw std::runtime_error("Missing sigma key: " + key);
			}
			try {
				return std::any_cast<T>(it->second);
			} catch (const std::bad_any_cast&) {
				throw std::runtime_error("Type mismatch in sigma key: " + key);
			}
		}

		void printSigmaValue(const SigmaValue& value){
        ...
        void functioninit4Variable(){
			sigmaStore<int>("Variable0_0_0_10currentValue", 0);
}
void function6initializeVar(){
	int Variable0_0_0_101376;
	Variable0_0_0_101376 = 1;
			sigmaStore<int>("Variable0_0_0_10currentValue", Variable0_0_0_101376);
}
void functioninit8Variable(){
			sigmaStore<int>("Variable1_0_1_10currentValue", 0);
}
void function10initializeVar(){
	int Variable1_0_1_101376;
	Variable1_0_1_101376 = 4;
			sigmaStore<int>("Variable1_0_1_10currentValue", Variable1_0_1_101376);
}
void functioninit12Variable(){
			sigmaStore<int>("Variable2_0_2_10currentValue", 0);
}
void function14initializeVar(){
	int Variable2_0_2_101376;
	Variable2_0_2_101376 = 0;
			sigmaStore<int>("Variable2_0_2_10currentValue", Variable2_0_2_101376);
}
void function92executeAssignment2(int resRight){
	int Assignment16_0_16_202523;
	Assignment16_0_16_202523 = resRight;
			sigmaStore<int>("Variable2_0_2_10currentValue", Assignment16_0_16_202523);
}
int function53accessVarRef(){
	int VarRef7_4_7_61582;
			VarRef7_4_7_61582 = sigmaLoad<int>("Variable0_0_0_10currentValue");
...
void function21executeAssignment2(int resRight){
	...
	sigmaStore<int>("Variable1_0_1_10currentValue", Assignment4_7_4_212523);
}
void function35executeAssignment2(int resRight){
	int Assignment5_7_5_212523;
	Assignment5_7_5_212523 = resRight;
	sigmaStore<int>("Variable1_0_1_10currentValue", Assignment5_7_5_212523);
}
bool function104evalBooleanConst(){
	sigmaStore<bool>("BooleanConst16_6_16_10constantValue", true);
	bool BooleanConst16_6_16_104605;
	BooleanConst16_6_16_104605 = sigmaLoad<bool>("BooleanConst16_6_16_10constantValue");
...
bool function107evalBooleanConst(){
	sigmaStore<bool>("BooleanConst16_14_16_19constantValue", false);
	bool BooleanConst16_14_16_194605;
	BooleanConst16_14_16_194605 = sigmaLoad<bool>("BooleanConst16_14_16_19constantValue");
...
void function61executeAssignment2(int resRight){
	...
	sigmaStore<int>("Variable1_0_1_10currentValue", Assignment9_4_9_182523);
}
void function78executeAssignment2(int resRight){
	int Assignment12_4_12_182523;
	Assignment12_4_12_182523 = resRight;
	sigmaStore<int>("Variable0_0_0_10currentValue", Assignment12_4_12_182523);
}
int function30accessVarRef(){
	int VarRef4_18_4_201582;
	VarRef4_18_4_201582 = sigmaLoad<int>("Variable0_0_0_10currentValue");
...
int function28accessVarRef(){
	...
	VarRef4_13_4_151582 = sigmaLoad<int>("Variable0_0_0_10currentValue");
...
int function44accessVarRef(){
	...
	VarRef5_18_5_201582 = sigmaLoad<int>("Variable1_0_1_10currentValue");
...
int function42accessVarRef(){
	...
	VarRef5_13_5_151582 = sigmaLoad<int>("Variable1_0_1_10currentValue");
...
int function70accessVarRef(){
	...
	VarRef9_15_9_171582 = sigmaLoad<int>("Variable0_0_0_10currentValue");
...
int function68accessVarRef(){
	...
	VarRef9_10_9_121582 = sigmaLoad<int>("Variable1_0_1_10currentValue");
...
int function87accessVarRef(){
	...
	VarRef12_15_12_171582 = sigmaLoad<int>("Variable0_0_0_10currentValue");
...
int function85accessVarRef(){
	...
	VarRef12_10_12_121582 = sigmaLoad<int>("Variable1_0_1_10currentValue");
