...
void function89executeAssignment2(int resRight)
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((int *)sigma["Variable2_0_2_10currentValue"]) = Assignment16_0_16_202534;
	}
}
int function50accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef7_4_7_61593 = *(int *)sigma["Variable0_0_0_10currentValue"];
	}
...
void function18executeAssignment2(int resRight)
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((int *)sigma["Variable1_0_1_10currentValue"]) = Assignment4_7_4_212534;
	}
}
void function32executeAssignment2(int resRight)
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((int *)sigma["Variable1_0_1_10currentValue"]) = Assignment5_7_5_212534;
	}
}
bool function100evalBooleanConst()
{
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		sigma["BooleanConst16_6_16_10constantValue"] = new bool();
	}
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((bool *)sigma["BooleanConst16_6_16_10constantValue"]) = true;
	}
	bool BooleanConst16_6_16_104616;
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		BooleanConst16_6_16_104616 = *(bool *)sigma["BooleanConst16_6_16_10constantValue"];
	}
...
bool function102evalBooleanConst()
{
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		sigma["BooleanConst16_14_16_19constantValue"] = new bool();
	}
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((bool *)sigma["BooleanConst16_14_16_19constantValue"]) = false;
	}
	bool BooleanConst16_14_16_194616;
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		BooleanConst16_14_16_194616 = *(bool *)sigma["BooleanConst16_14_16_19constantValue"];
	}
...
void function58executeAssignment2(int resRight)
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((int *)sigma["Variable1_0_1_10currentValue"]) = Assignment9_4_9_182534;
	}
}
void function75executeAssignment2(int resRight)
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		*((int *)sigma["Variable0_0_0_10currentValue"]) = Assignment12_4_12_182534;
	}
}
int function27accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef4_18_4_201593 = *(int *)sigma["Variable0_0_0_10currentValue"];
	}
...
int function41accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef5_18_5_201593 = *(int *)sigma["Variable1_0_1_10currentValue"];
	}
...
int function39accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef5_13_5_151593 = *(int *)sigma["Variable1_0_1_10currentValue"];
	}
...
int function67accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef9_15_9_171593 = *(int *)sigma["Variable0_0_0_10currentValue"];
	}
...
int function65accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef9_10_9_121593 = *(int *)sigma["Variable1_0_1_10currentValue"];
	}
...
int function84accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef12_15_12_171593 = *(int *)sigma["Variable0_0_0_10currentValue"];
	}
...
int function82accessVarRef()
{
	...
	{
		const std::lock_guard<std::mutex> lock(sigma_mutex);
		VarRef12_10_12_121593 = *(int *)sigma["Variable1_0_1_10currentValue"];
	}
