...
export function activateCCFGDebug(context: vscode.ExtensionContext, factory?: vscode.DebugAdapterDescriptorFactory) {
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand('extension.CCFG-debug.debugEditorContents', (resource: vscode.Uri) => {
			let targetResource = resource;
			if (!targetResource && vscode.window.activeTextEditor) {
				targetResource = vscode.window.activeTextEditor.document.uri;
			}
		...
		vscode.commands.registerCommand('extension.CCFG-debug.toggleFormatting', (variable) => {
	...
	context.subscriptions.push(vscode.commands.registerCommand('extension.CCFG-debug.getProgramName', config => {
	...
	// here we match only CCFG "variables", that are words starting with an '$'
...
class CCFGConfigurationProvider implements vscode.DebugConfigurationProvider {
...
class InlineDebugAdapterFactory implements vscode.DebugAdapterDescriptorFactory {
	...
	createDebugAdapterDescriptor(_session: vscode.DebugSession): ProviderResult<vscode.DebugAdapterDescriptor> {
		return new vscode.DebugAdapterInlineImplementation(new CCFGDebugSession(workspaceFileAccessor));
	}
}