import { CreateEventChannelInstruction, EmitEventInstruction, WaitEventInstruction, AckEventInstruction, AddSleepInstruction, AssignVarInstruction, CCFG, CreateGlobalVarInstruction, CreateVarInstruction, Instruction, OperationInstruction, ReturnInstruction, SetGlobalVarInstruction, SetVarFromGlobalInstruction } from "ccfg";
                ...
                for (const fname of node.functionsNames) {
                    ...
                    for (const fdef of node.functionsDefs) {
                        ...
                        if  (fdef instanceof ReturnInstruction) {
                            ...
                            const b = fdef as CreateEventChannelInstruction;
